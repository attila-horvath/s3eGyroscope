...
{	
    ...
    {	
	   ...
	   m_SensorManager.unregisterListener(this);
		...
		{
     		m_SensorManager.registerListener(this, m_Gyroscope, SensorManager.SENSOR_DELAY_FASTEST);
		}	 
		else if(delay ==  DELAY_GAME)
		{		
			m_SensorManager.registerListener(this, m_Gyroscope, SensorManager.SENSOR_DELAY_GAME);	
		}
		else if(delay ==  DELAY_UI)
		{
			m_SensorManager.registerListener(this, m_Gyroscope, SensorManager.SENSOR_DELAY_UI);
				
		}
		else if(delay ==  DELAY_NORMAL)
		{		
